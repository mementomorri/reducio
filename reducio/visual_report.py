...
def _figures(result: Result) -> list[Any]:
    try:
        ...
        raise ReportError('HTML reports require: pip install "reducio[reports]"') from error
...
<title>reducio · {title}</title><style>{_REPORT_STYLE}</style></head><body><header>
<div class="navigation"><a class="brand" href="https://mementomorri.github.io/reducio/"><span class="logo-icon" aria-hidden="true">{_LOGO_SVG}</span>reducio</a>
<nav aria-label="Report navigation"><a href="#measurements">Measurements</a>
<a href="https://github.com/mementomorri/reducio/blob/main/docs/METRICS.md">Metric guide</a>
